...
public class KetQua extends javax.swing.JFrame {
    ...
    public KetQua() {
        ...
        setResizable(false);
        setTitle(new KetQuaDAO().docFile() + new KetQuaDAO().docFile1());
        txtDiem.setText(new KetQuaDAO().tinhDiem()+"");
    }
    ...
    private void initComponents() {
        ...
        txtDiem.setFont(new java.awt.Font("Tahoma", 1, 56)); // NOI18N
        txtDiem.setText("9.99");
